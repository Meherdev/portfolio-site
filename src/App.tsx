        ...
        <section id="home" className="relative mx-auto flex min-h-[60svh] max-w-6xl flex-col lg:flex-row items-center justify-center gap-8 px-4 py-24">
          ...
          <div className="flex-1 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-8">
              ...
              <a
                href="https://instagram.com/alwaysmeher"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center p-2.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200"
            ...
            {([
              {
                ...
                image: { src: '/src/assets/youtube.jpg', alt: 'YouTube Summarizer Preview' },
              ...
              },
              {
                ...
                image: { src: '/src/assets/expense.jpg', alt: 'Expense Tracker Preview' },
